...
export default function Profile() {
	...
	useEffect(() => {
		...
		console.log(user_name, data?.results[0]?.user_name, true)
	...
	return (
		<div className=' flex-col text-white flex gap-6 p-3 max-w-full my-7 mx-10 max-md:mx-7 max-md:4'>
			...
			<div className='flex flex-col gap-3 px-6'>
				...
				{user_name && <div className='flex fle-row gap-3'><span className='font-bold'>Username  :</span>  <span> {user_name}</span></div>}
